...
export default function AddBoardPopUp() {
  ...
  const backgrounds = [
    ...
    { id: "1", url: background["1"].mobile["1x"] },
    { id: "2", url: background["2"].mobile["1x"] },
    { id: "3", url: background["3"].mobile["1x"] },
    { id: "4", url: background["4"].mobile["1x"] },
    { id: "5", url: background["5"].mobile["1x"] },
    { id: "6", url: background["6"].mobile["1x"] },
    { id: "7", url: background["7"].mobile["1x"] },
    { id: "8", url: background["8"].mobile["1x"] },
    { id: "9", url: background["9"].mobile["1x"] },
    { id: "10", url: background["10"].mobile["1x"] },
    { id: "11", url: background["11"].mobile["1x"] },
    { id: "12", url: background["12"].mobile["1x"] },
    { id: "13", url: background["13"].mobile["1x"] },
    { id: "14", url: background["14"].mobile["1x"] },
    { id: "15", url: background["15"].mobile["1x"] },
  ];
